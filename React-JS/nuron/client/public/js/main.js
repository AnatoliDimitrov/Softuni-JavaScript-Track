(function ($) {
    ...
    var imJs = {
        ...
        unloadImage: function name() {
            $("body").on('click', "#rbtinput1", function (e) {
                $("#fatima").click();
            });
            ...
            $("body").on('change', "#fatima", function () {
                rbtPreview(this);
            });
        },

        unloadImage2: function name() {
            $("body").on('click',"#rbtinput2", function (e) {
                $("#nipa").click();
            });
        ...
        unloadImage3: function name() {
            $("body").on('click', "#createfileImage", function (e) {
            ...
            $("body").on('change', "#createinputfile", function () {
                rbtPreview(this);
            });
        },

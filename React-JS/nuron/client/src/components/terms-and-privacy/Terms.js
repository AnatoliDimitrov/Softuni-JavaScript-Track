        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-6 col-md-6 col-12">
                    <h5 className="title text-center text-md-start">Terms & Condition</h5>
                </div>
                <div className="col-lg-6 col-md-6 col-12">
                    <ul className="breadcrumb-list">
                        <li className="item"><Link to="/">Home</Link></li>
                        <li className="separator"><i className="feather-chevron-right"></i></li>
                        <li className="item current">Terms & Condition</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div className="terms-condition-area rn-section-gapTop">
        <div className="container">
            ...
            {/* <div className="row mt--50">
                <div className="offset-lg-2 col-lg-8">
                    <Link to="#" className="btn btn-primary mr--15">Accept</Link>
                    <Link to="#" className="btn btn-primary-alta">Decline</Link>
                </div>
            </div> */}
        </div>
    </div>

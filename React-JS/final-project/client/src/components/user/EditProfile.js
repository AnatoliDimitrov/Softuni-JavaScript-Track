                                ...
                                <div className="tab-pane fade" id="nav-homes" role="tabpanel" aria-labelledby="nav-home-tab">
                                    ...
                                    <div className="nuron-information">
                                        ...
                                        <div className="profile-form-wrapper">
                                            <div className="input-two-wrapper mb--15">
                                                <div className="first-name half-wid">
                                                    <label for="contact-name" className="form-label">First Name</label>
                                                    <input name="contact-name" id="contact-name" type="text" value="First Name..." />
                                                </div>
                                                <div className="last-name half-wid">
                                                    <label for="contact-name-last" className="form-label">Last Name</label>
                                                    <input name="contact-name" id="contact-name-last" type="text" value="Last Name..." />
                                                </div>
                                            </div>
                                            <div className="email-area">
                                                <label for="Email" className="form-label">Edit Your Email</label>
                                                <input name="email" id="Email" type="email" value="example@mail.com" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="edit-bio-area mt--20">
                                            <label for="Discription" className="form-label">Edit Your Bio</label>

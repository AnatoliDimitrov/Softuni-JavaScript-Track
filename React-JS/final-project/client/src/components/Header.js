                                        ...
                                        <div className="row row--0">
                                            ...
                                            <div className="col-lg-3 single-mega-item">
                                                <ul className="mega-menu-item">
                                                    ...
                                                    <li><a href="forum-community.html">Forum and Community<i data-feather="message-circle"></i></a></li>
                                                </ul>
                                            </div>
                                            <div className="col-lg-3 single-mega-item">
                                                <ul className="mega-menu-item">
                                                    ...
                                                    <li><a href="terms-condition.html">Terms and Condition <i data-feather="list"></i></a></li>

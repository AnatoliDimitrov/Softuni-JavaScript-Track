                        ...
                        <div className="offset-2 col-lg-4 col-md-6 ml_md--0 ml_sm--0 col-sm-12">
                            <div className="form-wrapper-one registration-area">
                                ...
                                <form>
                                    ...
                                    <div className="mb-5">
                                        <label for="sastName" className="form-label">Last name</label>
                                    ...
                                    <div className="mb-5">
                                        <label for="newPassword" className="form-label">Create Password</label>
                                    ...
                                    <div className="mb-5 rn-check-box">
                                        ...
                                        <label className="rn-check-box-label" for="exampleCheck1">Allow to all tearms & condition</label>
                                    </div>
